function lbl3DeleteChannels
% Deletes all labels in specified channels. Channels specified by their number.
...
for kf = 1 : length(filepn)
    ...
    lblSet = lblSet(~ismember(lblSet.Channel, chToRemove), :);
    sigInfo(chToRemove, :) = [];
