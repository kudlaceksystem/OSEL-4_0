function lbl3JoinFiles01
% Checks whether there is the same number of channels in both lbl3 files. This might be unnecessary and cause trouble occassionally.
