function rhs_data = read_Intan_RHS2000_jk(file, path)
'ahoj'
% % % filename = 'NLU_250827_105345.rhs';
...
if (data_present)
    ...
    % Package into a struct for return
    rhs_data = struct();
    rhs_data.file_version        = file_version;
    rhs_data.frequency_parameters = struct('amplifier_sample_rate', sample_rate);
    rhs_data.amplifier_data      = amplifier_data;
    rhs_data.t_amplifier         = t_amplifier;
    rhs_data.amplifier_channels  = amplifier_channels;
    % Add other streams if needed (ADC, stim, digital, etc.)
