function deleteLabelsNotBelongingToTheFile02
% Deletes labels of specified type (label class) which have posN lower than the yymmdd_HHMMSS in the file name. Safety margin 2 seconds.
