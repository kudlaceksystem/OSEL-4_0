...
%             obj.plotTbl = obj.sigTbl(ismember(obj.sigTbl.ChName, obj.chToPlot), :);
            ...
            signalMargin = 0.05;
            for k = 1 : numch
                obj.h.axChNm(k) = axes('Parent', obj.h.panChNm, ...
                    'Position', [0, signalMargin + (1-2*signalMargin)*(numch-k)/numch, 1, (1-2*signalMargin)*1/numch], ...
            ...
            for k = 1 : numch
                % Create axes
                obj.h.axSig(k) = axes('Parent', obj.h.panSig, ...
                    'Position', [0, signalMargin + (1-2*signalMargin)*(numch-k)/numch, 1, (1-2*signalMargin)*1/numch], ...
